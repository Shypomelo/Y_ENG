            ...
            <header className="sticky top-0 z-50 w-full border-b bg-white dark:bg-zinc-950">
              <div className="container mx-auto max-w-5xl flex h-14 items-center gap-6 px-4 sm:px-6">
                ...
                <nav className="flex items-center gap-4 text-sm font-medium text-zinc-600 dark:text-zinc-400 sm:gap-6 overflow-x-auto whitespace-nowrap scrollbar-hide">
                  ...
                  <Link href="/inventory" className="whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white transition-colors">庫存管理</Link>
                  ...
                  <Link href="/admin" className="whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 hover:text-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800 dark:hover:text-white transition-colors">管理台</Link>
                </nav>
              </div>
            </header>
